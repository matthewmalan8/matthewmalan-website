      ...
      <section className="bg-[var(--color-black)] text-[var(--color-off-white)]">
        <div className="max-w-7xl mx-auto px-6 lg:px-10 pt-20 pb-12 lg:pt-28">
          ...
          <p className="mt-6 max-w-2xl text-lg text-[var(--color-warm-gray)] leading-relaxed">
            Every session. Every set. Pulled straight from{" "}
            <a
              href="https://hevy.com"
              target="_blank"
              rel="noopener noreferrer"
              className="underline hover:text-[var(--color-yellow)]"
            >
              Hevy
            </a>
            .
                ...
                <div className="flex items-start justify-between gap-3 flex-wrap">
                  ...
                  <div className="relative">
                    ...
                    <select
                      ...
                      className="appearance-none pl-3 pr-9 py-1.5 rounded-full border border-[var(--color-warm-gray)]/40 bg-transparent text-xs font-semibold text-[var(--color-off-white)] focus:outline-none cursor-pointer"
                    >
                      {TIME_RANGES.map((r) => (
                        <option
                          key={r.value}
                    ...
                    <ChevronDownIcon className="absolute right-2.5 top-1/2 -translate-y-1/2 w-3 h-3 pointer-events-none text-[var(--color-off-white)]" />
                  </div>
                </div>
                <p className="mt-4 font-[family-name:var(--font-display)] text-5xl lg:text-6xl tracking-tight">
